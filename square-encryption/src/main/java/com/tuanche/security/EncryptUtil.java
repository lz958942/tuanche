...
import com.tuanche.security.util.Constant.Charset;
...
public class EncryptUtil {
	...
	public static String secretKey = "LmMGStGtOpF4xNyvYt54EQ==";
	...
	public static String encrypt(String xmlStr, String secretKey, String symmetryAlgorithm) {
		...
		try {
			// 取需要加密内容的UTF-8编码。
			encrypt = xmlStr.getBytes(Charset.UTF8);
	...
	public static String decrypt(String xmlStr, String secretKey, String symmetryAlgorithm) throws Exception {
		...
		return new String(temp, 16, temp.length - 16, Charset.UTF8);
	}
	...
	public static byte[] MD5Hash(byte[] buf, int offset, int length) throws Exception {
		MessageDigest md = MessageDigest.getInstance(Algorithm.Summary.MD5);
	...
	public static String encodeMD5(String str) {
		return encode(str, Algorithm.Summary.MD5);
	}
	...
	public static String encodeSHA(String str) {
		return encode(str, Algorithm.Summary.SHA);
	}
